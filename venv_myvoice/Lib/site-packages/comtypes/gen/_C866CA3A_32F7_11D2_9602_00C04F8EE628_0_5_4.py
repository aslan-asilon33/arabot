...
__all__ = [
    ...
    'SpeechDataKeyLocation', 'SpeechAddRemoveWord',
    'ISpeechLexiconPronunciations', 'ISpeechDataKey',
    'Speech_StreamPos_Asap', 'DISPID_SRCEInterference',
    'SpeechVoiceCategoryTTSRate', 'SPEI_INTERFERENCE', 'SP_VISEME_4',
    'DISPID_SRCERecognitionForOtherContext', 'SVP_21',
    'SVEAudioLevel', 'DISPID_SAVolume', 'SRSActiveAlways',
    'IInternetSecurityManager', 'DISPID_SPAPhraseInfo',
    'DISPID_SWFEChannels', 'DISPID_SpeechVoiceStatus',
    'SGRSTTDictation', 'DISPID_SVEViseme', 'ISpeechPhraseProperty',
    'DISPID_SRGState', 'DISPID_SRCAudioInInterferenceStatus',
    'ISpAudio', 'DISPID_SVSpeakCompleteEvent', 'ISpeechLexicon',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SGRSTPropertyId',
    'DISPID_SRRPhraseInfo', 'SPWT_LEXICAL', 'SGRSTTRule',
    'SAFTCCITT_uLaw_11kHzMono', 'SAFT22kHz16BitStereo',
    'DISPID_SDKSetBinaryValue', 'SpInprocRecognizer', 'SASStop',
    'SGDSActiveWithAutoPause', 'SAFT11kHz16BitStereo',
    'DISPID_SVEBookmark', 'DISPID_SLGetGenerationChange',
    'ISpRecoContext', 'SITooSlow', 'DISPID_SGRInitialState',
    'ISpeechRecoGrammar', 'ISpeechGrammarRuleStateTransition',
    'IStream', 'SECFDefault', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechPhraseElements', 'SPSTREAMFORMATTYPE',
    'DISPID_SLPPartOfSpeech', 'eLEXTYPE_PRIVATE20',
    'SPWORDPRONUNCIATIONLIST', 'eLEXTYPE_APP', 'SPSHT_Unknown',
    'DISPID_SBSSeek', 'ISpeechRecoResult', 'ISpNotifySink',
    'SP_VISEME_12', 'SVP_15', 'SpeechVoiceEvents',
    'eLEXTYPE_PRIVATE18', 'SREStreamEnd',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPGS_EXCLUSIVE',
    'DISPID_SRGId', 'eLEXTYPE_PRIVATE1', 'SPAUDIOBUFFERINFO',
    'SpeechCategoryAudioIn', 'SAFT24kHz8BitStereo',
    'DISPID_SLPsCount', 'DISPID_SMSGetData',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SGRsFindRule',
    'SPGRAMMARWORDTYPE', 'Speech_Max_Word_Length', 'DISPID_SRCState',
    'DISPID_SpeechMemoryStream', 'SPEVENTSOURCEINFO',
    'eLEXTYPE_PRIVATE8', 'SREPropertyStringChange',
    'Speech_Default_Weight', 'DISPID_SRRTStreamTime',
    'SREPropertyNumChange', 'DISPID_SLWType', 'SPPS_Verb',
    'SPVISEMES', 'SpeechTokenContext', 'eLEXTYPE_PRIVATE9',
    'SPSNotOverriden', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SDKEnumValues', 'SPRECOCONTEXTSTATUS', 'SVSFPersistXML',
    'SPAUDIOSTATE', 'DISPID_SPEAudioStreamOffset', 'eWORDTYPE_ADDED',
    'DISPID_SRGIsPronounceable', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SVEStreamEnd', 'SpeechPropertyResourceUsage',
    'eLEXTYPE_PRIVATE11', 'SECHighConfidence', 'SpeechCategoryVoices',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SABIMinNotification',
    'DISPID_SGRSTRule', 'DISPID_SVEPhoneme', 'SpeechAudioProperties',
    'ISpeechAudioStatus', 'eLEXTYPE_PRIVATE19',
    'DISPID_SOTRemoveStorageFileName', 'SPFM_CREATE',
    'DISPID_SDKEnumKeys', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SpeechRecoResult2', 'SP_VISEME_5',
    'DISPID_SpeechObjectTokens', 'DISPID_SVSVisemeId',
    'SPDKL_DefaultLocation', 'SpeechVoiceSpeakFlags', 'SPPHRASE',
    'SpeechAudioFormatGUIDText', 'ISpeechObjectTokenCategory',
    'eLEXTYPE_PRIVATE17', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRRTOffsetFromStart',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRGSetWordSequenceData', 'SpeechBookmarkOptions',
    'IEnumSpObjectTokens', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRCEAdaptation', 'DISPID_SRGRecoContext', 'SVP_1',
    'SRAExport', 'DISPID_SRRTLength', 'SRSEIsSpeaking',
    'SPEI_START_SR_STREAM', 'DISPID_SLGenerationId', 'SLTUser',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SOTDataKey',
    'DISPID_SPERetainedStreamOffset', 'SREBookmark',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SPPsItem',
    'DISPID_SPRules_NewEnum', 'SPSMF_SRGS_SAPIPROPERTIES', 'SVP_8',
    'DISPID_SOTCreateInstance', 'DISPID_SRRTTickCount',
    'SpeechTokenShellFolder', 'SECNormalConfidence',
    'DISPID_SRGCmdLoadFromObject', 'SPEI_MIN_SR',
    'DISPID_SpeechAudioStatus', 'DISPID_SGRSTransitions',
    'ISpRecoContext2', 'ISpPhoneticAlphabetSelection',
    'DISPID_SBSFormat', 'SPEI_REQUEST_UI',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPEI_SOUND_START',
    'DISPID_SPRulesItem', 'SPPS_Noncontent', 'SPCT_SUB_COMMAND',
    'SpeechRegistryLocalMachineRoot', 'SDTAudio', 'SPEI_PHRASE_START',
    'DISPID_SpeechMMSysAudio', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SPEDisplayAttributes', 'SAFTADPCM_22kHzMono',
    'DISPID_SASNonBlockingIO', 'SPCATEGORYTYPE',
    'SpeechDisplayAttributes', 'DISPID_SRDisplayUI', 'SP_VISEME_0',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpMMAudioIn',
    'DISPID_SPRNumberOfElements', 'SPSSuppressWord',
    'DISPID_SRCEEndStream', 'SVP_0', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SCSBaseStream', 'SPEI_SR_RETAINEDAUDIO',
    'SAFT24kHz16BitMono', 'SPXMLRESULTOPTIONS', 'SRTSMLTimeout',
    'SPRECORESULTTIMES', 'SVEViseme', 'DISPID_SVSpeak', 'SGDisplay',
    'SPADAPTATIONRELEVANCE', 'SPEI_SENTENCE_BOUNDARY',
    'SPWORDPRONUNCIATION', 'DISPID_SRCERecognition',
    'ISpResourceManager', 'DISPID_SpeechLexiconProns',
    'DISPID_SOTCEnumerateTokens', 'SGDSInactive',
    'ISpeechLexiconWord', 'DISPID_SRRRecoContext', 'DISPID_SOTCSetId',
    'SPLO_DYNAMIC', 'ISpeechPhraseReplacement',
    'SAFTCCITT_ALaw_22kHzMono', 'SGDSActiveUserDelimited',
    'SPPS_RESERVED4', 'SVPNormal', 'DISPID_SGRAddState', 'SINoise',
    'SPRST_INACTIVE', 'SpPhoneticAlphabetConverter',
    'SPINTERFERENCE_NONE', 'SPXRO_Alternates_SML', 'SITooFast',
    'DISPID_SGRs_NewEnum', 'SPLO_STATIC', 'DISPID_SPRuleParent',
    'SpMMAudioEnum', 'ISpeechCustomStream',
    'DISPID_SRSCurrentStreamPosition', 'SAFT12kHz16BitMono',
    'ISpeechLexiconPronunciation', 'SVP_18', 'DISPID_SGRSTsItem',
    'SpeechWordType', 'SAFTGSM610_11kHzMono',
    'DISPID_SPPFirstElement', 'DISPID_SpeechVoiceEvent',
    'SAFTGSM610_22kHzMono', 'SAFT12kHz8BitMono', 'SPCONTEXTSTATE',
    ...
    'DISPID_SRGCmdLoadFromMemory', 'SpeechGrammarTagWildcard',
    'DISPID_SpeechAudioFormat', 'DISPID_SDKDeleteKey', 'SRAONone',
    'SpeechStreamFileMode', 'SpLexicon', 'ISpeechPhoneConverter',
    'DISPID_SPAsItem', 'ISpeechRecoResultDispatch', 'DISPID_SAFType',
    'SASRun', 'DISPID_SRGCommit', 'STSF_CommonAppData',
    'DISPID_SDKGetStringValue', 'ISpXMLRecoResult',
    'eLEXTYPE_RESERVED6', 'DISPID_SRRAlternates', 'DISPID_SVEWord',
    'DISPID_SPEPronunciation', 'SPEI_FALSE_RECOGNITION',
    'SAFTCCITT_ALaw_44kHzMono', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPRST_ACTIVE', 'SPDATAKEYLOCATION', 'DISPID_SGRsCommitAndSave',
    'SpeechRecoContextState', 'SPAUDIOSTATUS', 'SPCS_DISABLED',
    'DISPID_SAStatus', 'DISPID_SRRDiscardResultInfo', 'SP_VISEME_8',
    'SPPS_NotOverriden', 'SAFTGSM610_44kHzMono', 'SP_VISEME_9',
    'DISPID_SGRSTsCount', 'DISPID_SVVolume', 'ISpeechLexiconWords',
    'ISpRecoGrammar', 'SpMMAudioOut', 'ISpVoice', 'SWTAdded',
    'DISPID_SGRSAddWordTransition', 'SAFTCCITT_uLaw_22kHzStereo',
    'SpTextSelectionInformation', 'SPSHT_EMAIL', 'SAFT16kHz8BitMono',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRGRules',
    'DISPID_SpeechPhraseElement', 'SPEI_RESERVED2',
    'SpPhoneConverter', 'ISpeechGrammarRule',
    'DISPID_SpeechPhraseAlternates', 'SPSModifier', 'SPEI_PHONEME',
    'SPBO_NONE', 'DISPID_SRCEStartStream', 'DISPID_SOTGetAttribute',
    'SPBOOKMARKOPTIONS', 'SpObjectTokenCategory',
    'SPINTERFERENCE_NOSIGNAL', 'SP_VISEME_16',
    'DISPID_SRSSupportedLanguages', 'DISPID_SpeechLexicon',
    'DISPID_SRSAudioStatus', 'SPEI_RESERVED1', 'SVP_14',
    'SPPS_Function', 'DISPID_SDKCreateKey', 'SVSFParseMask',
    'SPVPRI_OVER', 'DISPID_SGRsItem', 'DISPID_SGRSTPropertyName',
    'DISPID_SPRuleConfidence', 'SpNotifyTranslator',
    'SPTEXTSELECTIONINFO', 'ISpNotifyTranslator', 'DISPID_SBSRead',
    'SPEI_TTS_PRIVATE', 'DISPID_SLPType', 'DISPID_SOTCId',
    'SAFT48kHz8BitStereo', 'SRSEDone',
    'ISpeechTextSelectionInformation', 'SVP_5',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpPhoneConverter', 'SRAImport',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SWFEBlockAlign',
    'SpeechWordPronounceable', 'DISPID_SpeechRecognizer',
    'DISPID_SPIGetText', 'SP_VISEME_3', 'SpResourceManager',
    'DISPID_SRCERecognizerStateChange', 'eLEXTYPE_PRIVATE15',
    'SAFT48kHz8BitMono', 'DISPID_SVSPhonemeId', 'DISPID_SOTDisplayUI',
    'SP_VISEME_19', 'DISPID_SRProfile',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechRecognizer',
    'tagSPTEXTSELECTIONINFO', 'ISequentialStream',
    'DISPID_SMSADeviceId', 'DISPID_SGRName', 'SDTReplacement',
    'ISpeechAudioFormat', 'SRARoot', 'SP_VISEME_14',
    'SAFT44kHz8BitStereo', 'DISPID_SPRDisplayAttributes',
    'SAFT12kHz8BitStereo', 'DISPID_SGRSTText',
    'DISPID_SLGetPronunciations', 'SRTExtendableParse',
    'DISPID_SpeechPhoneConverter', 'SpSharedRecoContext',
    'SAFTCCITT_uLaw_44kHzMono', 'SP_VISEME_6',
    'SpeechCategoryRecoProfiles', 'DISPID_SRCRetainedAudioFormat',
    'SRTStandard', 'SSTTTextBuffer', 'ISpeechGrammarRuleState',
    'SDTAll', 'DISPID_SRRAudioFormat', 'SPEI_START_INPUT_STREAM',
    'SPPHRASEPROPERTY', 'DISPID_SPRuleName', 'SAFTDefault',
    'SpeechVisemeFeature', 'ISpeechMemoryStream',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SDKLDefaultLocation',
    'DISPID_SDKGetlongValue', 'SPFM_CREATE_ALWAYS', 'SRAInterpreter',
    'DISPID_SPIStartTime', 'DISPID_SPRsItem', 'SPSERIALIZEDRESULT',
    'ISpeechGrammarRules', 'SPDKL_CurrentConfig', 'SPGS_DISABLED',
    'SSSPTRelativeToStart', 'SpeechPartOfSpeech', 'SASClosed',
    'DISPID_SVRate', 'SPINTERFERENCE_NOISE', 'SECFIgnoreCase',
    'SGSEnabled', 'SVF_Emphasis', 'DISPID_SRGDictationUnload',
    'ISpRecognizer3', 'DISPID_SPERequiredConfidence',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRRGetXMLResult',
    'eLEXTYPE_RESERVED4', 'SpeechCategoryRecognizers',
    'SPEI_RESERVED3', 'SpeechRegistryUserRoot',
    'DISPID_SDKGetBinaryValue', 'SpeechLexiconType',
    'DISPID_SpeechGrammarRuleState', 'SECFIgnoreKanaType',
    'SPBO_PAUSE', 'SPEI_VISEME', 'DISPID_SVSpeakStream',
    'DISPID_SpeechRecognizerStatus', 'SPEI_SR_BOOKMARK',
    'ISpeechFileStream', 'SPEI_UNDEFINED', 'DISPID_SVEVoiceChange',
    'DISPID_SpeechPhraseInfo', 'DISPID_SASetState',
    'DISPID_SVEStreamStart', 'eLEXTYPE_RESERVED8',
    'Speech_Max_Pron_Length', 'SPEVENTENUM', 'SRTAutopause',
    'SDTProperty', 'SpeechAudioFormatGUIDWave',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPIRule',
    'SAFT16kHz8BitStereo', 'DISPID_SPPNumberOfElements',
    'Speech_StreamPos_RealTime', 'SpSharedRecognizer',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPPS_Noun', 'SREInterference',
    'DISPID_SRCResume', 'SREAdaptation', 'DISPID_SRSetPropertyString',
    'SRATopLevel', 'DISPID_SOTCDefault', 'SWPKnownWordPronounceable',
    'LONG_PTR', 'DISPID_SRGReset', 'DISPID_SRCEBookmark', 'SBONone',
    'SpeechRuleState', 'SPSHT_NotOverriden', 'ISpShortcut',
    'SPPS_Interjection', 'DISPID_SOTCategory', 'SPEI_RECOGNITION',
    'SAFT8kHz16BitStereo', 'SRAORetainAudio', 'DISPID_SPEDisplayText',
    'SGRSTTTextBuffer', 'SPWORDLIST', 'eLEXTYPE_USER', 'SREAllEvents',
    'SVEPhoneme', 'DISPID_SpeechVoice', 'SP_VISEME_10',
    'DISPID_SLWWord', 'SPFM_OPEN_READWRITE', 'ISpEventSink',
    'SLOStatic', 'SPDKL_LocalMachine', 'SPEI_SR_AUDIO_LEVEL',
    'SAFTADPCM_22kHzStereo', 'SP_VISEME_20', 'DISPID_SDKDeleteValue',
    'DISPID_SWFEExtraData', 'SPFILEMODE', 'DISPID_SGRSTWeight',
    'SpAudioFormat', 'SVPAlert', 'DISPID_SRGetFormat',
    'SpPhraseInfoBuilder', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRGSetTextSelection', 'ISpProperties', 'SRERecognition',
    'DISPID_SRCEPropertyNumberChange', 'tagSTATSTG',
    'SpeechAllElements', 'SPSLMA', 'ISpeechMMSysAudio',
    'SAFT11kHz8BitMono', 'DISPID_SpeechFileStream',
    'SAFTADPCM_44kHzStereo', 'SVP_7', 'DISPID_SpeechPhraseProperties',
    'SpeechCategoryAudioOut', 'STCInprocHandler', 'SSFMOpenReadWrite',
    'SDTLexicalForm', 'DISPID_SpeechAudio',
    'DISPID_SVSInputWordLength', 'DISPID_SPRFirstElement',
    'SAFTADPCM_11kHzMono', 'SPVPRI_NORMAL',
    'ISpPhoneticAlphabetConverter', 'SPSEMANTICERRORINFO',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechPropertyAdaptationOn', 'SpFileStream',
    'DISPID_SpeechRecoContext', 'DISPID_SVStatus', 'SpeechRecoEvents',
    'SFTSREngine', 'DISPID_SLWsCount', 'SpeechTokenKeyUI',
    ...
    'DISPID_SPEsItem', 'SPAR_Low', 'SVF_Stressed', 'SPSHORTCUTTYPE',
    'SP_VISEME_7', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SGRsCount', 'SPSNoun', 'DISPID_SDKSetStringValue',
    'DISPID_SOTGetDescription', 'SP_VISEME_11', 'ISpRecoCategory',
    'SpeechStreamSeekPositionType', 'SVSFIsXML', 'SSTTWildcard',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRCRequestedUIType', 'DISPID_SRCESoundStart',
    'DISPID_SABIBufferSize', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SGRsAdd', 'STCRemoteServer', 'DISPID_SOTIsUISupported',
    'SPINTERFERENCE_TOOLOUD', 'SpeechLoadOption', 'SPLEXICONTYPE',
    'DISPID_SLAddPronunciation', 'SPAS_RUN', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPCLangId', 'SVEVoiceChange', 'SAFTADPCM_11kHzStereo',
    'SPWORDTYPE', '_RemotableHandle', 'SpeechCategoryAppLexicons',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SABufferNotifySize',
    'DISPID_SVESentenceBoundary', 'DISPID_SRCPause',
    'DISPID_SPPs_NewEnum', 'DISPID_SPIGrammarId',
    'SpStreamFormatConverter', 'SSTTDictation', 'SRCS_Disabled',
    'SpeechGrammarTagDictation', 'SVP_19', 'DISPID_SpeechRecoResult',
    'DISPID_SRCEPhraseStart', 'SPEI_MAX_SR', 'DISPID_SPELexicalForm',
    'SPEVENT', 'SVSFParseAutodetect', 'SAFTADPCM_8kHzStereo',
    'SAFT22kHz16BitMono', 'SPINTERFERENCE_TOOQUIET',
    'ISpStreamFormat', 'SDTDisplayText', 'SpObjectToken',
    'SAFT32kHz16BitMono', 'ISpObjectToken', 'SGLexicalNoSpecialChars',
    'DISPID_SGRClear', 'DISPID_SRRSetTextFeedback',
    'ISpeechBaseStream', 'ISpeechPhraseProperties',
    'DISPID_SPPEngineConfidence', 'ISpeechVoiceStatus', 'SRSActive',
    'DISPID_SPRs_NewEnum', 'DISPID_SpeechLexiconWords', 'SVP_11',
    'DISPID_SPPParent', 'DISPID_SRCEventInterests',
    'ISpeechAudioBufferInfo', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPIDSPTSI_ActiveLength', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFT44kHz16BitMono', 'DISPID_SpeechDataKey', 'DISPID_SVPause',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SRCCreateResultFromMemory', 'SpCompressedLexicon',
    'SGRSTTEpsilon', 'SpeechEmulationCompareFlags',
    'ISpeechWaveFormatEx', 'DISPID_SRGetPropertyString', 'SVP_9',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SDKSetLongValue',
    'SBOPause', 'WAVEFORMATEX', 'SAFTCCITT_uLaw_11kHzStereo',
    'SASPause', 'SPWT_PRONUNCIATION', 'SPRST_INACTIVE_WITH_PURGE',
    'SP_VISEME_18', 'SP_VISEME_2', 'ISpeechPhraseAlternates',
    'DISPID_SpeechGrammarRule', 'SPEI_MIN_TTS',
    'DISPID_SWFEBitsPerSample', 'DISPID_SpeechPhraseRules',
    'DISPID_SPANumberOfElementsInResult', 'ISpeechXMLRecoResult',
    'SITooLoud', 'SpeechFormatType', 'SRESoundEnd',
    'DISPID_SMSSetData', 'DISPID_SPARecoResult', 'tagSPPROPERTYINFO',
    'SAFT32kHz16BitStereo', 'SAFT44kHz8BitMono',
    'ISpStreamFormatConverter', 'DISPID_SVEventInterests',
    'SPEI_END_SR_STREAM', 'SPBO_AHEAD', 'DISPID_SRCEHypothesis',
    'SpeechAudioFormatType', 'DISPID_SRIsShared', 'SPAS_CLOSED',
    'ISpeechPhraseElement', 'DISPID_SpeechObjectToken',
    'STCInprocServer', 'SPCT_SLEEP', 'DISPID_SVSInputWordPosition',
    'DISPID_SLPs_NewEnum', 'SPSMF_UPS', 'ISpeechObjectTokens',
    'DISPID_SLPPhoneIds', 'SVP_13', 'DISPID_SRSCurrentStreamNumber',
    'SPAS_PAUSE', 'SPPS_SuppressWord', 'DISPID_SAFGuid',
    'DISPID_SPIReplacements', 'ISpeechResourceLoader',
    'ISpeechRecoResultTimes', 'STCAll', 'SPBO_TIME_UNITS',
    'SVSFParseSsml', 'SVSFIsFilename', 'DISPID_SABIEventBias',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRSTType',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SOTMatchesAttributes', 'DISPID_SVIsUISupported',
    'DISPID_SPIEnginePrivateData', 'SAFTCCITT_ALaw_11kHzStereo',
    'SVP_12', 'SP_VISEME_21', 'SPVPRIORITY', 'DISPID_SVSkip',
    'SPEI_RECO_STATE_CHANGE', 'SWPUnknownWordUnpronounceable',
    'SDA_Two_Trailing_Spaces', 'SPSVerb', 'DISPID_SPRulesCount',
    'DISPID_SVGetVoices', 'DISPID_SLPLangId', 'SPLOADOPTIONS',
    'DISPID_SPPChildren', 'SPWT_DISPLAY', 'DISPID_SVResume',
    'SPBINARYGRAMMAR', 'SREHypothesis', 'DISPID_SPACommit',
    'SPEI_TTS_AUDIO_LEVEL', 'SVP_3', 'SPPHRASERULE',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVSLastResult',
    'SPPS_LMA', 'DISPID_SGRsCommit', 'SpWaveFormatEx',
    '_ISpeechRecoContextEvents', 'SAFTGSM610_8kHzMono',
    'DISPID_SVDisplayUI', 'SPCS_ENABLED',
    'DISPIDSPTSI_SelectionLength', 'SAFT48kHz16BitStereo', 'SVPOver',
    ...
    'SREPrivate', 'DISPID_SFSOpen', 'SPAUDIOOPTIONS',
    'DISPID_SRAudioInput', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPRText', 'SPCT_DICTATION', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPIAudioStreamPosition', 'SPAR_Medium',
    'ISpeechPhraseRule', 'SVEAllEvents', 'DISPID_SVWaitUntilDone',
    'SVEBookmark', 'DISPID_SpeechPhraseReplacement',
    'SpeechDiscardType', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRCERequestUI', 'DISPID_SRRAudio', 'SpeechVisemeType',
    'SREStateChange', 'SpVoice', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPEI_HYPOTHESIS', 'DISPID_SRCCreateGrammar', 'SPWORD',
    'SPEI_ADAPTATION', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SPIProperties', 'SpeechUserTraining', 'STSF_FlagCreate',
    'SDA_No_Trailing_Space', 'SGDSActive',
    'ISpeechGrammarRuleStateTransitions', 'SREStreamStart',
    'DISPID_SVSRunningState', 'SRTEmulated', 'SDTRule',
    ...
    'SAFTText', 'SPEI_VOICE_CHANGE', 'SSFMOpenForRead',
    'DISPID_SpeechPhraseReplacements', 'SpeechTokenKeyAttributes',
    'ISpNotifySource', 'DISPID_SOTsCount',
    'DISPID_SpeechRecoResultTimes', 'SPRULESTATE',
    'SPPHRASEREPLACEMENT', 'SPRULE', 'SPSERIALIZEDPHRASE',
    'STSF_LocalAppData', 'eLEXTYPE_PRIVATE3', 'DISPID_SOTId',
    'SPRS_ACTIVE', '_SPAUDIOSTATE', 'SREAudioLevel',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRGetPropertyNumber',
    'DISPID_SVVoice', 'SVP_20', 'DISPID_SVSLastBookmark',
    'SRSInactive', 'ISpPhrase', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRSClsidEngine', 'SAFT8kHz16BitMono',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SGRSAddSpecialTransition',
    'SPGS_ENABLED', 'SVF_None', 'SPSHORTCUTPAIR', 'SVSFNLPMask',
    'SPPARTOFSPEECH', 'ISpeechPhraseInfo', 'SpeechMicTraining',
    'SAFT44kHz16BitStereo', 'SP_VISEME_13', 'DISPID_SRCBookmark',
    'SVSFNLPSpeakPunc', 'DISPID_SLRemovePronunciation', 'SWTDeleted',
    'eLEXTYPE_PRIVATE16', 'ISpeechPhraseRules',
    'SpeechSpecialTransitionType', 'SPEI_MAX_TTS', 'SGRSTTWildcard',
    'SpeechGrammarState', 'SpeechCategoryPhoneConverters',
    'eLEXTYPE_RESERVED7', 'ISpeechRecognizerStatus',
    'DISPID_SVEEnginePrivate', 'SPWF_INPUT',
    'SpeechVoiceSkipTypeSentence', 'SPEI_SR_PRIVATE',
    'IInternetSecurityMgrSite', 'ISpeechVoice', 'SGLexical',
    'DISPID_SRCreateRecoContext', 'eLEXTYPE_PRIVATE7', 'SVSFIsNotXML',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechAudioVolume',
    'DISPID_SPRsCount', 'SpStream', 'DISPID_SBSWrite', 'ISpDataKey',
    'SRCS_Enabled', 'ISpeechRecoResult2',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRStatus',
    'DISPID_SPRuleId', 'SVEPrivate', 'SAFT22kHz8BitStereo',
    'DISPID_SVPriority', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpGrammarBuilder', 'SDKLCurrentUser', 'DISPID_SRCEAudioLevel',
    'SAFT22kHz8BitMono', 'DISPID_SRGDictationSetState',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRRSaveToMemory',
    'SPPROPERTYINFO', 'eLEXTYPE_LETTERTOSOUND', 'SPAO_RETAIN_AUDIO',
    'SPSUnknown', 'SVSFParseSapi', 'DISPID_SVSInputSentenceLength',
    'DISPID_SPAs_NewEnum', 'SPEI_RESERVED6',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPPHRASEELEMENT',
    'DISPID_SWFEFormatTag', 'SRERecoOtherContext',
    'SAFT24kHz8BitMono', 'SpeechGrammarWordType',
    'SPEI_WORD_BOUNDARY', 'SPRST_ACTIVE_ALWAYS', 'SPPS_RESERVED3',
    'SLTApp', 'SVP_4', 'ISpObjectWithToken', 'SVP_16',
    'DISPID_SRCVoicePurgeEvent', 'SRESoundStart',
    'DISPID_SRAudioInputStream', 'SP_VISEME_1', 'DISPID_SOTSetId',
    'DISPID_SPAsCount', 'SDA_Consume_Leading_Spaces',
    'eLEXTYPE_PRIVATE5', 'DISPID_SGRSRule', 'SVP_6',
    'SVSFPurgeBeforeSpeak', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPEs_NewEnum', 'DISPID_SPAStartElementInResult',
    'DISPID_SpeechPhraseRule', 'SPWF_SRENGINE', 'SPINTERFERENCE',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SOTRemove',
    'ISpeechPhraseAlternate', 'SSFMCreate', 'SVESentenceBoundary',
    'SAFT16kHz16BitMono', 'SAFT48kHz16BitMono', 'SGPronounciation',
    'SLODynamic', 'DISPID_SVGetProfiles', 'DISPID_SAEventHandle',
    'DISPID_SpeechAudioBufferInfo', 'SDA_One_Trailing_Space',
    'DISPID_SLWsItem', 'DISPID_SLPSymbolic', 'SPRS_INACTIVE',
    'DISPID_SRGDictationLoad', 'SPAR_High', 'SpShortcut',
    'ISpeechRecoContext', 'DISPID_SMSALineId', 'ISpPhraseAlt',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SpeechWaveFormatEx', 'SPCT_SUB_DICTATION',
    'DISPID_SASState', 'DISPID_SLGetWords', 'ISpeechPhraseElements',
    'DISPID_SPRuleChildren', 'SpUnCompressedLexicon',
    'eLEXTYPE_RESERVED10', 'SPRECOSTATE',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPCPhoneToId',
    'DISPID_SPPsCount', 'DISPID_SpeechLexiconWord',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRState', 'SpeechEngineConfidence',
    'DISPID_SLWs_NewEnum', 'SSFMCreateForWrite', 'SFTInput',
    'DISPID_SpeechGrammarRules', 'eWORDTYPE_DELETED',
    'SpeechTokenKeyFiles', 'SECFEmulateResult',
    'DISPID_SPILanguageId', 'DISPID_SRCRetainedAudio',
    'DISPID_SLPsItem', 'ISpRecognizer', 'SGSExclusive',
    'SPGRAMMARSTATE', 'ISpMMSysAudio', 'SpNullPhoneConverter',
    'UINT_PTR', 'DISPID_SGRSAddRuleTransition', 'IEnumString',
    'DISPID_SVEAudioLevel', 'DISPID_SPPId',
    'SSSPTRelativeToCurrentPosition', 'SpeechRecognitionType',
    'SAFT12kHz16BitStereo', 'SRADynamic',
    'DISPID_SPIRetainedSizeBytes', 'SpMemoryStream',
    'DISPID_SpeechPhraseBuilder', 'DISPIDSPRG', 'SVSFVoiceMask',
    ...
    'DISPID_SPEAudioSizeTime', 'ISpeechAudio', 'DISPID_SRCESoundEnd',
    'ISpeechPhraseReplacements', 'SRERequestUI', 'DISPID_SGRId',
    'SINone', 'DISPID_SVSLastStreamNumberQueued', 'ISpSerializeState',
    'SpeechVoicePriority', 'SPVPRI_ALERT', 'DISPID_SRGetRecognizers',
    'SAFTNoAssignedFormat', 'DISPID_SRSetPropertyNumber',
    'SP_VISEME_15', 'SPPS_Unknown', 'ISpLexicon', 'SPEI_RESERVED5',
    'eLEXTYPE_MORPHOLOGY', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPEActualConfidence', 'SITooQuiet', 'DISPID_SPIEngineId',
    'SAFTExtendedAudioFormat', 'SpeechPropertyResponseSpeed',
    'SP_VISEME_17', 'SAFTCCITT_uLaw_44kHzStereo', 'SPAS_STOP',
    'DISPID_SWFEAvgBytesPerSec', 'SGRSTTWord', 'SVSFDefault',
    'SPFM_OPEN_READONLY', 'DISPID_SPEEngineConfidence',
    'DISPID_SPPValue', 'eLEXTYPE_PRIVATE6', 'DISPID_SGRAddResource',
    'DISPID_SGRsDynamic', 'SVP_10', 'SpeechEngineProperties',
    'SpCustomStream', 'DISPID_SOTCGetDataKey', 'SPDKL_CurrentUser',
    'SVSFlagsAsync', 'DISPID_SPCIdToPhone', 'SAFTADPCM_44kHzMono',
    'SVP_2', 'SGSDisabled', 'SpeechTokenIdUserLexicon',
    'STCLocalServer', 'DISPID_SVSCurrentStreamNumber',
    'SpInProcRecoContext', 'SPSInterjection', 'SPSHT_OTHER',
    'DISPID_SGRSTNextState', 'SAFT8kHz8BitStereo',
    'SAFT24kHz16BitStereo', 'SPXRO_SML', 'SINoSignal',
    'DISPID_SPPConfidence', 'DISPID_SPISaveToMemory',
    'DISPID_SRCVoice', 'SREFalseRecognition',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPIElements',
    'SRSInactiveWithPurge', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpeechObjectToken', 'DISPID_SRRecognizer', 'ISpEventSource',
    'SPVOICESTATUS', 'SpeechRetainedAudioOptions',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPPS_RESERVED2',
    'SDKLLocalMachine', 'SPCT_COMMAND', 'SECFNoSpecialChars',
    'ISpRecognizer2', 'SECLowConfidence',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVEEndInputStream',
    'SpeechInterference', 'SREPhraseStart', 'SAFT8kHz8BitMono',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SFSClose', 'DISPID_SOTsItem',
    'SSSPTRelativeToEnd', 'STSF_AppData', 'SAFT11kHz16BitMono',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPEI_SOUND_END',
    'DISPID_SRIsUISupported', 'SVP_17', 'DISPID_SRRTimes',
    'DISPID_SPERetainedSizeBytes', 'SVEStartInputStream',
    'SpeechTokenValueCLSID', 'SPAR_Unknown', 'SECFIgnoreWidth',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SGRAttributes',
    'SAFT32kHz8BitStereo', 'SVEWordBoundary',
    'DISPID_SADefaultFormat', 'SPSFunction', 'DISPID_SPEsCount',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVGetAudioInputs', 'SDKLCurrentConfig',
    'SPRST_NUM_STATES', 'SAFT16kHz16BitStereo',
    'DISPID_SRRSpeakAudio', 'DISPID_SRGCmdSetRuleState',
    'SpeechAudioState', 'SDTPronunciation', 'DISPIDSPTSI',
    'SPPS_RESERVED1', 'SPFM_NUM_MODES', 'DISPID_SRCSetAdaptationData',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SABufferInfo', 'ISpStream',
    'SRTReSent', 'SPRECOGNIZERSTATUS', 'ISpRecoResult',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SLWLangId',
    'ISpRecoGrammar2', '_ISpeechVoiceEvents',
...
_check_version('1.2.1', 1698381339.320019)
